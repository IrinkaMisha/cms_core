package rw.ktc.cms.material.parsetonode;
...
public abstract class NodeExt implements INodeExt {
    private static final Logger logger = LoggerFactory.getLogger(NodeExt.class);
    @JsonIgnore
    protected Node node;
    ...
    public Long getId() {
        return ((NodeImpl)node).getId();
    }

    public void setId(Long id) {
        ((NodeImpl)this.node).setId(id);
    }
    ...
    protected void pastAllData(){
        if(null==node || node.getId()==null) return;
        Object bean=this;
    ...
    public void pastAllData(boolean includeSuperClass, List<String> methodsExclude, List<String> fieldsExclude){
        if(((NodeImpl)node).getId()==null) return;
        Object bean=this;
        Class klass = bean.getClass();
        /* If klass.getSuperClass is System class then force includeSuperClass to false. */
        if (klass.getClassLoader() == null) {
