        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="rootFrame">
            ...
            <tr>
                ...
                <td width="40%"><div class="dataBlock"><div class="bopen"><div class="hederData flexHeader">
                    ...
                    <div>&nbsp;</div><div class="body"><div>${user.getOnePropertyValue(user, "fname")}  ${user.getOnePropertyValue(user, "lname")}  ${user.getOnePropertyValue(user, "pname")}</div><div>${user.getOnePropertyValue(user, "wphone")}</div><div>${user.getOnePropertyValue(user, "mphone")}</div><div>${user.getOnePropertyValue(user, "email")}</div><div></div></div>
                    <div>&nbsp;</div>
