...
public class NewUserForm{
    ...
    public User createUserFromThis(Role role){
        ...
        List<NodeProperty> lnp=us.getNodeProperties();
        lnp.add(new NodeProperty("fname", getFname()));
        lnp.add(new NodeProperty("lname",getLname()));
        lnp.add(new NodeProperty("pname",getPname()));
        lnp.add(new NodeProperty("wphone",getWorkPhone()));
        lnp.add(new NodeProperty("mphone",getMobilePhone()));
        lnp.add(new NodeProperty("email",getEmail()));
        lnp.add(new NodeProperty("id_dep",getId_dep()));
        lnp.add(new NodeProperty("ecUn",getId_ecUn()));
        lnp.add(new NodeProperty("id_proff",getId_proff()));
        lnp.add(new NodeProperty("id_proffShort",getId_proffShort()));
        us.setActive(true);
        return us;
    }
}
